 ...
 */
  ...
  (function () {
    emailjs.init("f2t3Z7uqe5zzoIWUi"); // thay bằng key của bạn
  })();

  document.getElementById("contactForm").addEventListener("submit", function (e) {
    e.preventDefault();

    // Ẩn/hiện các trạng thái
    ...
    emailjs.sendForm("service_cnr1yk3", "template_r4fmmqu", this).then(
      function () {
      ...
      function (error) {
        ...
        errorMessage.innerText = "Gửi không thành công. Lỗi: " + error.text;
      }
    );
  });
